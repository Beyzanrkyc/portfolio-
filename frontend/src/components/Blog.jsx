            ...
            <div className="relative bg-gradient-to-br from-yellow-500/10 via-transparent to-yellow-400/5 border border-yellow-500/20 rounded-2xl overflow-hidden group hover:border-yellow-400/40 transition-all duration-300">
              ...
              <div className="p-8 md:p-12">
                ...
                <button
                  ...
                  className="group/btn inline-flex items-center gap-2 px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-lg transition-all duration-300"
                >
                  Read Article
            ...
            {filteredPosts.length > 0 ? (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredPosts.map((post, idx) => (
                  // ✅ UPDATED: cursor-pointer + onClick to navigate
                  <article
                    key={post.id}
                    onClick={() => navigate(`/blog/${post.id}`)}
                    className="cursor-pointer group bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:bg-white/10 hover:border-yellow-400/30 transition-all duration-300 hover:-translate-y-1 flex flex-col"
